...
public class Main {
    public static void main(String[] args) {
        ...
        PCGame juego6 = new PCGame("Batman™: Arkham Knight", "Acción, Mundo Abierto, Superhéroes, Sigilo", 50000, "Requiere un PROCESADOR y un sistema operativo de 64 bits, SO: Win 7 SP1, Win 8.1 de 64 bits,\n PROCESADOR: Intel Core i5-750, 2.67 GHz | AMD Phenom II X4 965, 3.4 GHz,\n MEMORIA: 6 GB de RAM, \nGRÁFICOS: Graphics: NVIDIA GeForce GTX 660 (2 GB Mínimo) | AMD Radeon HD 7870 (2 GB Mínimo),\n DIRECTX: Versión 11, RED: Conexión de banda ancha a Internet, ALMACENAMIENTO: 45 GB de espacio disponible.");
